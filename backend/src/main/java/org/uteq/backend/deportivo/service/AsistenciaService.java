...
public class AsistenciaService {
    ...
    /**
     * Registrar o actualizar asistencia de un estudiante en una sesiÃƒÆ’Ã‚Â³n
    ...
    public AsistenciaResponse registrarAsistencia(Long idSesion, Long idEstudiante, AsistenciaRequest request) {
        ...
        SesionEntrenamiento sesion = sesionRepository.findById(idSesion)
                .orElseThrow(() -> new IllegalArgumentException("SesiÃƒÆ’Ã‚Â³n no encontrada"));
        ...
        Asistencia asistencia = asistenciaRepository
                .findBySesionAndEstudiante(sesion, estudiante)
                .orElse(null);
    ...
    /**
     * Obtener todas las asistencias de una sesiÃƒÆ’Ã‚Â³n
     */
    ...
    /**
     * Obtener asistencia especÃƒÆ’Ã‚Â­fica
     */
    @Transactional(readOnly = true)
