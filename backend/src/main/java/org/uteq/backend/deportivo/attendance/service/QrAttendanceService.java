...
public class QrAttendanceService {
     ...
     *         codifique como QR
     */
    public QrToken issue(Long idSesion) {
        ...
        return new QrToken(token, ttlSegundos);
    }
     ...
     */
    public Optional<Long> redeem(String token) {
     ...
     */
    public record QrToken(String token, int expiraEnSegundos) {}
}
