...
es su total real de \emph{commits} en \texttt{main} (Tabla~\ref{tab:credit-cifras}
de la sección anterior); CRediT clasifica tipos de contribución
intelectual, no un archivo por rol —un mismo \emph{commit} puede sostener
varios roles a la vez—, así que el conteo es el total verificable de la
persona, no una partición exclusiva por rol.
...
\midrule
Conceptualización & Ricardo (55), Darwin (136) & Diseño de los cuatro dominios (académico, deportivo, inventario, seguridad) y de la estrategia híbrida de acceso a datos. \\
Curación de datos & Alejandro (233) & Diseño del esquema, procedimientos almacenados y limpieza de los datos crudos de medición. \\
Análisis formal & Alejandro (233) & Análisis estadístico de los datos de rendimiento y usabilidad (intervalos de confianza, distribución \emph{t}). \\
Adquisición de fondos & --- & No aplica (proyecto académico sin financiación externa). \\
Investigación & Darwin (136) & Relevamiento de requisitos con la escuela ProFútbol y recolección de evidencia empírica. \\
Metodología & Ricardo (55) & Proceso de investigación (DSR) y protocolo de medición. \\
Administración del proyecto & Darwin (136) & Administración del proyecto, calendario y gestión de entregas. \\
Recursos & Ricardo (55) & Configuración del entorno de despliegue (Render), contenedores Docker y base de datos. \\
Software & Alejandro (233), Ricardo (55), Darwin (136) & Implementación de backend (Spring~Boot), \emph{frontend} (Angular) y procedimientos almacenados. \\
Supervisión & Darwin (136) & Coordinación del equipo y seguimiento del repositorio. \\
Validación & Alejandro (233), Ricardo (55) & Cobertura (JaCoCo), pruebas de carga (k6), estudio de usabilidad (SUS) y auditoría de seguridad. \\
Visualización & Alejandro (233) & Diagramas C4 y de arquitectura del sistema. \\
Redacción (borrador original) & Alejandro (233) & Redacción del informe, del SRS y de la documentación técnica. \\
Redacción (revisión y edición) & Ricardo (55) & Revisión y corrección de la documentación y su consistencia con el código. \\
\bottomrule
\end{tabular}
\end{table}
