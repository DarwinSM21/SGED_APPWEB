...
etiqueta \texttt{v1.0.0}, cuyo \emph{commit} consta arriba. Los tres
ORCID ya están registrados y verificados contra la API pública de
\url{orcid.org}. El único campo que sigue marcado \pendiente{} es el
DOI del \emph{dataset}, que depende del depósito en Zenodo y no de este
repositorio; se declara como faltante en vez de omitirlo, siguiendo la
misma disciplina que \ruta{VERSIONING.md}
