...
Scale}, $N=15$), todas archivadas como datos crudos reproducibles.
...
$N=15$), all archived as reproducible raw data. \textbf{Main results.}
...
100\,\% de \emph{branches}. El estado agregado actual —86,12\,\% de
líneas, 71,21\,\% de \emph{branches}, con las capas que todavía quedan
por debajo del umbral— se reporta en la sección~\ref{sec:cobertura}.
...
\textbf{Estado actual.} El sistema creció después de la primera corrida
—nuevos módulos de partidos, representantes, consentimientos, entre
otros— y la suite de pruebas creció con él. Medido con
\texttt{./mvnw clean test} sobre \texttt{jacoco.csv}
(\ruta{docs/mediciones/jacoco/}): \textbf{86,12\,\% de cobertura de
líneas} (1924 de 2234) y \textbf{71,21\,\% de \emph{branches}} (413 de
580), sobre 156 clases analizadas, con \textbf{479 pruebas} en 64 clases
de prueba. Cumple el \textbf{70\,\%} que exige \texttt{pom.xml} en
líneas y en \emph{branches} —el umbral real del proyecto; una
redacción anterior de este párrafo citaba 60\,\%, que nunca fue el
valor configurado—.
...
\midrule
Servicios & 88,91\,\% (1251/1407) & 72,66\,\% (279/384) \\
Controladores & 85,37\,\% (321/376) & 82,81\,\% (53/64) \\
Otros (config., seguridad, DTO) & 81,82\,\% (342/418) & 64,04\,\% (73/114) \\
Entidades & \textbf{30,30\,\% (10/33)} & \textbf{44,44\,\% (8/18)} \\
\bottomrule
\end{tabular}
\end{table}

La capa que queda por debajo del umbral es la de entidades: la mayoría
...
\begin{itemize}[leftmargin=*]
  \item \textbf{La cobertura de instrucciones no mide calidad de las
    pruebas.} Un 86,12\,\% indica qué proporción del código se ejecuta
...
\begin{enumerate}[leftmargin=*]
  \item El sistema cumple con holgura los umbrales cuantitativos exigidos:
    ...
    100/100, y \textbf{86,12\,\%} de cobertura de líneas y
    \textbf{71,21\,\%} de \emph{branches} frente al mínimo de 70\,\%
    (sección~\ref{sec:cobertura}) — cifra alcanzada después de
