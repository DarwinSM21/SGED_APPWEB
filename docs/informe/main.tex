...
\textbf{Pendiente declarado:} las cinco corridas miden el mismo
escenario con caché caliente; quedan por hacer antes del cierre un
escenario de caché fría y su contraste inferencial frente al de caché
caliente con tamaño de efecto (Wilcoxon con \emph{Cliff's delta}), y la
corrección por comparaciones múltiples en el desglose de usabilidad por
perfil (sección~\ref{sec:sus}). El dato que gobierna RQ1 —la distancia
de p95 al umbral de 200\,ms— ya está medido cinco veces.
...
\url{https://github.com/darcalleg/SGED_APPWEB/actions}.
