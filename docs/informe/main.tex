...
\textbf{Etiqueta:} & \texttt{v1.0.2} \\[0.2cm]
\textbf{\emph{Commit} del corte:} & el \emph{commit} al que apunta la etiqueta \texttt{v1.0.2} \\[0.2cm]
\textbf{DOI del software:} & \href{https://doi.org/10.5281/zenodo.22635766}{10.5281/zenodo.22635766} (corte \texttt{v1.0.1}; pendiente nueva versión en Zenodo para \texttt{v1.0.2}) \\[0.2cm]
...
etiqueta \texttt{v1.0.2}, cuyo \emph{commit} consta arriba. Los tres
...
despliegue público en Render (\texttt{https://sged-frontend-jofa.onrender.com})
...
archivados como \texttt{docs/mediciones/lighthouse/public-*.report.json},
...
\midrule
Móvil & \texttt{/dashboard}  & 99,3 & 91,0 & 100 & 63 \\
Móvil & \texttt{/inventario} & 99,7 & 100 & 100 & 63 \\
Escritorio & \texttt{/dashboard}  & 80,0 & 91,0 & 100 & 63 \\
Escritorio & \texttt{/inventario} & 99,3 & 95,0 & 100 & 63 \\
\bottomrule
\end{tabular}
\end{table}

Todas las parejas superan los umbrales (rendimiento $\geq$ 80,
accesibilidad $\geq$ 90, buenas prácticas $\geq$ 90); el SEO de 63 es
la penalización deliberada de \texttt{is-crawlable} explicada en la
sección~\ref{sec:seo}. La escritorio/\texttt{/dashboard} queda exactamente en
el umbral de rendimiento (80,0) en las tres corridas, y la
...
\texttt{v1.0.1} de este repositorio está archivado con DOI
...
lo que satisface el archivo permanente exigido por el Bloque~E.2. La
entrega avanzó después a la etiqueta \texttt{v1.0.2} (recuperación de
contraseña y correcciones del SRS contra 29148:2018, sección~\ref{sec:estado-entrega});
queda pendiente publicar una nueva versión en Zenodo sobre el mismo
concept DOI para que el archivo permanente cubra ese corte, no solo
\texttt{v1.0.1}. La versión \texttt{v0.9.0-rc} del repositorio anterior
conserva su propio DOI heredado
...
\url{https://github.com/DarwinSM21/SGED_APPWEB}, etiqueta \texttt{v1.0.2}
(corte defendido; sucede a \texttt{v1.0.1}, que es la que tiene DOI
publicado). DOI del software en
