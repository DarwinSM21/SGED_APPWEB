...
\textbf{DOI del software:} & \href{https://doi.org/10.5281/zenodo.22635766}{10.5281/zenodo.22635766} \\[0.2cm]
...
sobre el umbral pasó de 0,06 a 1,24 puntos.
...
regenerando \texttt{target/} desde el código vigente: \textbf{87,47\,\%
de líneas} (2\,730 de 3\,121) y \textbf{72,10\,\% de \emph{branches}}
(672 de 932), sobre 200 clases y \textbf{576 pruebas} en 76 clases, sin
fallos; \texttt{reportes} subió a 93,8\,\% de líneas y
\texttt{common.exception} a 100\,\%. \textbf{Esta es la cifra
vigente en todo el documento} (sección~\ref{sec:cobertura}); las cuatro
...
priori (sección~\ref{sec:analisis-estadistico})— la caché cálida (corridas
2--5, tras descartar la primera de calentamiento de la JVM) da una media de
$11{,}28 \pm 4{,}66$\,ms (DT $2{,}93$), p95 $19{,}94 \pm 13{,}51$\,ms y
p99 $29{,}35 \pm 21{,}93$\,ms; la fría, media $17{,}74 \pm 1{,}72$\,ms
...
\textbf{Cifra de cierre (2026-09-07).} Esta es la única cifra de
...
no solo \texttt{test}—:
\textbf{87,47\,\% de cobertura de líneas} (2\,730 de 3\,121) y
\textbf{72,10\,\% de \emph{branches}} (672 de 932), sobre 200 clases
analizadas, con \textbf{576 pruebas} en 76 clases de prueba y ningún
fallo. Cumple el
...
margen de 2,10 puntos sobre el mínimo de \emph{branches}. Esta corrida
corresponde al pendiente de cobertura de la guía: se añadieron
\texttt{GlobalExceptionHandlerTest}, \texttt{ProblemDetailsAuthHandlersTest}
y casos nuevos de \texttt{ReportServiceTest}/\texttt{ReportControllerTest},
que llevaron \texttt{org.uteq.backend.reportes} (90,00\,\% el
\texttt{controller}, 94,03\,\% el \texttt{service}) y
\texttt{org.uteq.backend.common.exception} (100,00\,\%) por encima del
70\,\%. El camino
hasta esta cifra —41,9\,\% tras la reestructuración, 61,16\,\% con
\texttt{main} dos semanas en rojo, 70,06\,\% de cierre provisional el
 2026-09-02, 84,66\,\% del cierre anterior— queda documentado como
bitácora en la
...
\begin{itemize}[leftmargin=*]
  \item \textbf{La cobertura de instrucciones no mide calidad de las
    pruebas.} Un 87,47\,\% indica qué proporción del código se ejecuta
...
\href{https://doi.org/10.5281/zenodo.22635766}{10.5281/zenodo.22635766}
(concept DOI~\href{https://doi.org/10.5281/zenodo.21713239}{10.5281/zenodo.21713239}),
lo que satisface el archivo permanente exigido por el Bloque~E.2 y la
portada de este informe lo declara. La versión \texttt{v0.9.0-rc} del
repositorio anterior conserva su propio DOI heredado
...
\begin{enumerate}[leftmargin=*]
  \item El sistema cumple con holgura los umbrales cuantitativos exigidos:
    ...
    100/100, y \textbf{87,47\,\%} de cobertura de líneas y
    \textbf{72,10\,\%} de \emph{branches} frente al mínimo de 70\,\%
...
DOI del software en
Zenodo: \href{https://doi.org/10.5281/zenodo.22635766}{10.5281/zenodo.22635766}
(concept DOI
