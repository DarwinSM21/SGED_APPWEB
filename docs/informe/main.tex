...
{\ttfamily\url{https://github.com/DarwinSM21/SGED_APPWEB}}\\[0.6cm]
...
analizadas}—. Cobertura agregada de esa corrida:
75,3\,\% de líneas (cumplía el 70\,\%) pero
59,3\,\% de \emph{branches} (no cumplía, aunque mejoró frente al
...
\textbf{369 pruebas, 0 fallos}; agregada, 86,2\,\% de líneas y
71,2\,\% de \emph{branches} — fue la primera vez que ambas superaron el
70\,\% exigido sobre el \emph{bundle} completo, aunque el crecimiento
...
82,87\,\% de líneas y 70,06\,\% de \emph{branches} de esa corrida
— la regla volvía a cumplirse, pero con un margen de apenas 0,06 puntos
sobre el umbral: seguía siendo frágil frente al próximo módulo sin
pruebas propias.
...
de cierre con \texttt{mvn verify} en limpio: \textbf{84,66\,\% de
líneas} (2\,639 de 3\,117) y \textbf{71,24\,\% de \emph{branches}} (664
de 932), sobre 200 clases y \textbf{550 pruebas} en 74 clases; el margen
sobre el umbral pasó de 0,06 a 1,24 puntos. \textbf{Esta es la cifra
vigente en todo el documento} (sección~\ref{sec:cobertura}); las tres
actualizaciones anteriores quedan como el registro cronológico de cómo
se llegó a ella, no como cifras en disputa.
\end{quote}
...
automatizada. & \texttt{fabf893}, \texttt{84de825} \\
...
\textbf{Cifra de cierre (2026-09-03).} Esta es la única cifra de
...
no solo \texttt{test}—:
\textbf{84,66\,\% de cobertura de líneas} (2\,639 de 3\,117) y
\textbf{71,24\,\% de \emph{branches}} (664 de 932), sobre 200 clases
analizadas, con \textbf{550 pruebas} en 74 clases de prueba. Cumple el
\textbf{70\,\%} que exige \texttt{pom.xml} en líneas y en
\emph{branches} —el umbral real del proyecto; una redacción anterior de
este párrafo citaba 60\,\%, que nunca fue el valor configurado— con un
margen de 1,24 puntos sobre el mínimo de \emph{branches}. El camino
hasta esta cifra —41,9\,\% tras la reestructuración, 61,16\,\% con
\texttt{main} dos semanas en rojo, 70,06\,\% de cierre provisional el
 2026-09-02— queda documentado como bitácora en la
sección~\ref{sec:estado-entrega}; ninguna de esas cifras intermedias
describe el estado actual. El desglose por capa se resume en la
Tabla~\ref{tab:cobertura-por-capa}.
...
Controladores & 87,76\,\% (258/294) & 79,41\,\% (27/34) \\
Otros (config., seguridad, DTO) & 78,15\,\% (447/572) & 64,46\,\% (107/166) \\
...
\texttt{09c6edf}). Ningún controlador queda en cero.
...
\begin{itemize}[leftmargin=*]
  \item \textbf{La cobertura de instrucciones no mide calidad de las
    pruebas.} Un 84,66\,\% indica qué proporción del código se ejecuta
...
\midrule
Pallo Pinto Alejandro Daniel & 187 & 52\,016 & 556 \\
Arcalle Grefa Darwin Orlando & 49 & 29\,720 & 488 \\
Velez Lopez Ricardo Elias & 31 & 4\,458 & 105 \\
\midrule
\textbf{Total en \texttt{main}} & \textbf{267} & \textbf{86\,194} & --- \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{no} se repitió: 84{,}66\,\% de líneas (2\,639 de 3\,117) y
71{,}24\,\% de ramas (664 de 932) sobre el \texttt{main} que incluye ya
...
da sentido a la pregunta: allí la cobertura cayó a 39{,}8\,\% al agregar
cinco recursos sin pruebas propias y hubo que corregirla a 72{,}5\,\%;
aquí el crecimiento se acompañó de pruebas desde el principio y la cifra
subió en vez de caer.
...
\begin{enumerate}[leftmargin=*]
  \item El sistema cumple con holgura los umbrales cuantitativos exigidos:
    ...
    100/100, y \textbf{84,66\,\%} de cobertura de líneas y
    \textbf{71,24\,\%} de \emph{branches} frente al mínimo de 70\,\%
...
taxonomía CRediT, ocho están efectivamente asignados a algún integrante
—\emph{Conceptualización}, \emph{Metodología}, \emph{Software},
\emph{Validación}, \emph{Curación de datos}, \emph{Redacción (borrador
original)}, \emph{Visualización} y \emph{Administración del
proyecto}—; los seis restantes (\emph{Análisis formal},
\emph{Investigación}, \emph{Recursos}, \emph{Redacción (revisión y
edición)}, \emph{Supervisión}, \emph{Adquisición de fondos}) no
aplican a un Proyecto Fin de Curso sin financiamiento externo ni
supervisión formal más allá de la docente-directora, y no se fuerzan
para completar el conteo. El detalle por integrante, con evidencia
cuantitativa derivada del historial de \texttt{git} y no
autodeclarada, está en la sección~\ref{sec:credit} y en
\ruta{CONTRIBUTORS.md}.
