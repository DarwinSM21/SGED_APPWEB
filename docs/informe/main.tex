...
\textbf{Etiqueta:} & \texttt{v1.0.1} \\[0.2cm]
\textbf{\emph{Commit} del corte:} & el \emph{commit} al que apunta la etiqueta \texttt{v1.0.1} \\[0.2cm]
...
etiqueta \texttt{v1.0.1}, cuyo \emph{commit} consta arriba. Los tres
...
\url{https://github.com/DarwinSM21/SGED_APPWEB}, etiqueta \texttt{v1.0.1},
DOI del software en
