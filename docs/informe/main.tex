...
\textbf{Etiqueta:} & \texttt{v1.0.3} \\[0.2cm]
\textbf{\emph{Commit} del corte:} & el \emph{commit} al que apunta la etiqueta \texttt{v1.0.3} \\[0.2cm]
\textbf{DOI del software:} & \href{https://doi.org/10.5281/zenodo.22635766}{10.5281/zenodo.22635766} (corte \texttt{v1.0.1}; pendiente nueva versión en Zenodo para \texttt{v1.0.3}) \\[0.2cm]
...
etiqueta \texttt{v1.0.3}, cuyo \emph{commit} consta arriba. Los tres
...
entrega avanzó después a las etiquetas \texttt{v1.0.2} y \texttt{v1.0.3}
(recuperación de contraseña y correcciones del SRS contra 29148:2018 —M1--M9,
A1--A4 y M1--M3—, sección~\ref{sec:estado-entrega});
queda pendiente publicar una nueva versión en Zenodo sobre el mismo
concept DOI para que el archivo permanente cubra el corte vigente, no solo
...
\url{https://github.com/DarwinSM21/SGED_APPWEB}, etiqueta \texttt{v1.0.3}
