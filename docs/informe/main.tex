...
\begin{enumerate}[leftmargin=*]
  ...
  \item Queda abierto un frente que no puede resolverse escribiendo código:
    la encuesta SUS (sección~\ref{sec:sus}) requiere participantes externos
    reales y no se fabrica. La exposición REST del dominio deportivo
    restante (horarios, sesiones, asistencias, evaluaciones) es el objetivo
