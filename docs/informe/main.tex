...
\texttt{common.exception} a 100\,\%.

\textbf{Sexta actualización (2026-09-11).} Revisión contra
\texttt{Rubrica\_ExamenFinal\_SGED.pdf} (punto 2): el \texttt{SRS.md}
citaba 84,66\,\%/71,24\,\% —la cifra de la cuarta actualización, no la
vigente— y ninguna de las dos coincidía ya con el \texttt{jacoco.csv}
committeado tras el renombrado a inglés de los métodos fuera de
\texttt{deportivo} (Puntos E1/E2 de la misma rúbrica). Corrida de cierre:
\textbf{88,35\,\% de líneas} (3\,012 de 3\,409) y \textbf{74,20\,\% de
\emph{branches}} (791 de 1\,066), sobre 216 clases y \textbf{665 pruebas},
sin fallos. \textbf{Esta es la cifra vigente en todo el documento}
(sección~\ref{sec:cobertura}); las actualizaciones anteriores quedan como
el registro cronológico de cómo se llegó a ella, no como cifras en
disputa.
\end{quote}
...
no solo \texttt{test}—:
\textbf{88,35\,\% de cobertura de líneas} (3\,012 de 3\,409) y
...
margen de 4,20 puntos sobre el mínimo de \emph{branches}. Esta corrida
corresponde a la revisión contra \texttt{Rubrica\_ExamenFinal\_SGED.pdf}
(Punto 2): la cifra anterior (87,47\,\%/576 pruebas del 2026-09-07)
había quedado desincronizada del \texttt{SRS.md} (que citaba
84,66\,\%/71,24\,\%, una cifra de la bitácora, no la vigente) tras el
renombrado a inglés de los métodos fuera de \texttt{deportivo}
(Puntos E1/E2 de la misma rúbrica), que agregó cobertura nueva sin que
el CSV committeado se hubiese regenerado. El camino
hasta esta cifra —41,9\,\% tras la reestructuración, 61,16\,\% con
\texttt{main} dos semanas en rojo, 70,06\,\% de cierre provisional el
 2026-09-02, 84,66\,\% y luego 87,47\,\% de cierres anteriores— queda
documentado como
bitácora en la
...
\begin{itemize}[leftmargin=*]
  \item \textbf{La cobertura de instrucciones no mide calidad de las
    pruebas.} Un 88,35\,\% indica qué proporción del código se ejecuta
...
\begin{table}[htbp]
\centering
\caption{Evidencia cuantitativa de autoría por integrante (\texttt{git log} sobre \texttt{main}, medido el 2026-09-11). La misma medición está en \ruta{CONTRIBUTORS.md}. Arcalle Grefa suma los commits de sus dos correos vinculados a la misma cuenta de GitHub (\texttt{darcalleg@uteq.edu.ec} y \texttt{darwinarcalle@gmail.com}).}
...
\midrule
\textbf{Total en \texttt{main}} & \textbf{400} & \textbf{142\,303} & \textbf{3\,127} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{no} se repitió: 88{,}35\,\% de líneas (3\,012 de 3\,409) y
...
\begin{enumerate}[leftmargin=*]
  \item El sistema cumple con holgura los umbrales cuantitativos exigidos:
    ...
    100/100, y \textbf{88,35\,\%} de cobertura de líneas y
