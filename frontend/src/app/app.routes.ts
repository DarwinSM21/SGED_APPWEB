...
export const routes: Routes = [
  ...
  { path: 'restablecer', loadComponent: () => import('./auth/restablecer/restablecer.component').then(m => m.RestablecerComponent) },
  { path: 'confirmar-correo', loadComponent: () => import('./auth/confirmar-correo/confirmar-correo.component').then(m => m.ConfirmarCorreoComponent) },
  {
