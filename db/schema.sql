...
--
-- Es un PROCEDURE (no FUNCTION): @Procedure de Spring Data JPA llama esto
-- via CallableStatement {call ...}, y PostgreSQL solo acepta CALL contra
-- procedimientos reales, no contra funciones aunque tengan parametro OUT.
...
--            obligatoriamente en el motor según Bloque A.2.2).
-- Entrada:  p_categoria VARCHAR
-- Salida:   afectados INTEGER (parametro OUT, filas afectadas)
-- Tablas:   seguridad.estudiantes
-- Sin SQL dinámico. Parámetros nombrados.
